...
class UserService:
    ...
    async def create_user_with_profile(self, name: str, email: str, password: str, profile_data: dict, role: models.RoleEnum = models.RoleEnum.user, is_active: bool = True) -> models.User:
